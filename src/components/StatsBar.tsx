...
export const StatsBar: React.FC<StatsBarProps> = ({ videos, currentSort, onSortChange }) => {
  ...
  return (
    <div className="mb-6 p-4 rounded-2xl bg-slate-900/40 border border-slate-800/60 backdrop-blur-xl flex flex-wrap items-center justify-between gap-4">
      {/* Metrics */}
      <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-xs">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <span className="text-slate-400 font-medium block text-[10px] uppercase tracking-wider">My Library</span>
            <span className="font-bold text-slate-100 text-sm">{totalVideos} Videos</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 border-l border-slate-800/80 pl-4 sm:pl-6">
          ...
          <div className="min-w-[120px]">
            <div className="flex justify-between items-center text-[10px] text-slate-400 font-medium mb-1">
              ...
              <span className="font-semibold text-slate-200">{formatFileSize(totalStorage)}</span>
            </div>
        ...
        <div className="flex items-center gap-2.5 border-l border-slate-800/80 pl-4 sm:pl-6">
          <div className="p-2 rounded-xl bg-amber-500/10 text-amber-400 border border-amber-500/20">
            <Star className="w-4 h-4 fill-amber-400/20" />
          </div>
          <div>
            <span className="text-slate-400 font-medium block text-[10px] uppercase tracking-wider">Starred</span>
            <span className="font-bold text-amber-300 text-sm">{favoritesCount} Favorites</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <select
          ...
          className="px-3 py-1.5 text-xs font-semibold rounded-xl bg-slate-900 border border-slate-800 text-slate-200 focus:outline-none focus:border-blue-500 transition-colors cursor-pointer"
        >
